        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="{{ route('user.home') }}" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('photo/settings/general') }}/{{ generalSettings()->logo_lg_dark }}" alt="" height="60">
                    </span>
                </a>
                ...
                <a href="{{ route('user.home') }}" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="{{ asset('photo/settings/general') }}/{{ generalSettings()->logo_lg_light }}" alt="" height="60">
                    </span>
                </a>
            </div>
        ...
        <div class="d-flex">
            ...
            <div class="dropdown d-inline-block">
                ...
                data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img class="rounded-circle header-profile-user" src="{{ asset('photo/user_profile') }}/{{ Auth::guard('web')->User()->photo }}"
                        alt="Header Avatar">
                ...
                <div class="dropdown-menu dropdown-menu-end">
                    <!-- item-->
                    <a class="dropdown-item" href="{{ route('user.profile.index') }}"><i class="mdi mdi-face-profile font-size-16 align-middle me-1"></i> Profile</a>
